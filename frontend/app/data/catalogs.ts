...
export const PRESET_SPECS = [
  ...
  // Amazon (demo)
  { id: 'AMZ_SP_1x1', platform: 'Amazon', placement: 'Sponsored Display 1:1', width: 1200, height: 1200, orientation: 'Square', media_type: 'image', notes: 'High-contrast CTA; 20% text max.' },
  { id: 'AMZ_SP_1x1_VIDEO', platform: 'Amazon', placement: 'Sponsored Video 1:1', width: 1080, height: 1080, orientation: 'Square', media_type: 'video', notes: '6-15s; hook in first 1s.' },
  { id: 'AMZ_DSP_16x9', platform: 'Amazon', placement: 'DSP Video 16:9', width: 1920, height: 1080, orientation: 'Horizontal', media_type: 'video', notes: 'CTV-safe; show product in 2s.' },
  // Retail / CRM
  { id: 'CRM_EMAIL_HERO', platform: 'CRM', placement: 'Email Hero', width: 1200, height: 600, orientation: 'Horizontal', media_type: 'image', notes: 'Keep CTA above the fold.' },
  { id: 'CRM_EMAIL_TILE', platform: 'CRM', placement: 'Email Tile', width: 600, height: 600, orientation: 'Square', media_type: 'image', notes: 'Short copy; use overlays sparingly.' },
  { id: 'RETAIL_APP_BANNER', platform: 'Retail App', placement: 'App Banner', width: 1080, height: 400, orientation: 'Horizontal', media_type: 'image', notes: 'Keep logo left and CTA right.' },
];
